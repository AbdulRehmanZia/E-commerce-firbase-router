...
console.log(user);
    ...
    return(
        <>
 <div className="min-h-screen min-w-screen grid place-items-center mt-20 overflow-hidden">
      <div className="p-5  rounded text-center text-gray-500 max-w-sm mx-auto h-full">
