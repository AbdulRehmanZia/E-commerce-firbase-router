      ...
      <section className="text-gray-600 body-font overflow-hidden">
        ...
        <div className="container px-5 py-16 mx-auto ">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt={product.title}
              className="lg:w-1/2 w-full lg:h-auto h-auto object-cover object-center rounded border-2 border-black"
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button className="flex ml-auto text-white bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-slate-900 rounded">
                  Add To Cart
                </button>
